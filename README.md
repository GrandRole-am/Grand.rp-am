...
<img src="Wender.png" style="width:70%;" alt="Background - SAMP">
...
<div>
<!-- <div class="container_start1">
<img src="Play.png" style="width:70%;" alt="Background - SAMP">
<div class="centered_start3">Քայլ 2</div>
<div class="centered_start4">Ներբեռնելուց հետո GTA San-Andreas - ը <br>մեզ հետ խաղալու համար ձեզ հարկավոր է ներբեռնել SA:MP Multiplayer.<br> Ներբեռնեք մուլտիպլեյերի վերջին տարբերակը ձեր համակարգչում,<br> Ներբեռնելուց հետո տեղադրել այն խաղի թղթապանակում.</div>
<button1 class="center_2">ներբեռնել SA:MP - ը</button1>
</div>
</div> -->
